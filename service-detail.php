...
<body>
    ...
    <section class="hero" style="min-height:40vh; background:var(--bg-soft); text-align:center; padding-top:100px;">
        <i class="<?= htmlspecialchars($service['icon']) ?>"
            style="font-size:4rem; color:var(--primary); margin-bottom:2rem; display:block;"></i>
    ...
    <section class="bg-soft-blue" style="padding:80px 10%; border-top:1px solid var(--border-light);">
        <div class="fade-up" style="max-width:800px; margin:0 auto;">
            <div class="section-head" style="margin-bottom: 3rem;">
                <h3 style="font-size:2.5rem; margin-bottom:1rem; text-align:center;">Request a <span class="accent-text">Proposal</span></h3>
                <div class="underline"></div>
                <p style="text-align:center; color: var(--text-muted); margin-top:1.5rem;">Tell us about your project requirements and we will get back to you with a custom solution.</p>
            </div>
            ...
            <form action="process-inquiry.php" method="POST" class="card"
                ...
                <div style="margin-bottom:2rem;">
                    <label style="display:block; margin-bottom:0.5rem; font-weight:600; font-size:0.9rem;">Project Details</label>
                    <textarea name="message" placeholder="What are your goals with this project?" rows="5" required
                        style="width:100%; padding:1rem; border:1px solid var(--border); border-radius:8px; line-height:1.6;"></textarea>
                </div>

                <button type="submit" class="btn btn-primary"
                    style="width:100%; border:none; cursor:pointer; padding:1.25rem;">Submit Inquiry</button>
            </form>
        </div>
    </section>
