    ...
    <section style="padding:80px 10%;">
        <div class="card fade-up" style="max-width:800px; margin:0 auto; padding:4rem; line-height:2;">
            ...
            <div style="margin-top:3rem; border-top:1px solid var(--border); padding-top:3rem;">
                <h3 style="margin-bottom:2rem; font-size:1.5rem; text-align:center;">Request a <span
                        class="accent-text">Proposal</span></h3>

                <form action="process-inquiry.php" method="POST" class="card"
                    style="box-shadow: 0 10px 40px rgba(0,0,0,0.02); max-width:600px; margin:0 auto; padding:3rem;">
                    ...
                    <div style="margin-bottom:2rem;">
                        <textarea name="message" placeholder="What are your goals with this project?" rows="4" required
