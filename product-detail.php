...
<body>
    ...
    <section style="padding:100px 10%;">
        <div class="card fade-up" style="max-width:1000px; margin:0 auto; padding:4rem; line-height:2;">
            ...
            <div id="ask-question" style="margin-top:5rem; border-top:1px solid var(--border); padding-top:4rem;">
                <h3 style="margin-bottom:2rem; font-size:1.8rem; text-align:center;">Product <span class="accent-text">Inquiry</span></h3>
                <p style="text-align:center; color:var(--text-muted); margin-bottom:3rem;">Have questions about specification or licensing? Our team is ready to help.</p>
                
                <form action="process-inquiry.php" method="POST" class="card" style="box-shadow: 0 10px 40px rgba(0,0,0,0.02); max-width:700px; margin:0 auto; padding:3.5rem;">
                    ...
                    <div style="margin-bottom:2rem;">
                        <textarea name="message" placeholder="What specific information do you need about <?= htmlspecialchars($product['name']) ?>?" rows="4" required style="width:100%; padding:1rem; border:1px solid var(--border); border-radius:8px; line-height:1.6;"></textarea>
                    </div>
                    <button type="submit" class="btn btn-primary" style="width:100%; border:none; cursor:pointer; padding:1.25rem; font-size:1.1rem; font-weight:700;">Send Inquiry</button>
                </form>
            </div>
        </div>
    </section>
